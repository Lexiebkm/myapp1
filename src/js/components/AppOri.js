...
//import MouseTracker, {HOCMouseTracker} from "./mousetracker";
import FuncMouseTracker, {HOCMouseTracker} from "./funcmousetracker";
...
function App() {
  ...
  return (
    ...
    */}
          ...
          <ul className="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style={{bsScrollHeight: "100px"}}>                            
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu" aria-labelledby="navbarScrollingDropdown">      
                <li>
                  <Link to="/other/tabulator" className="dropdown-item">Tabulator Grid</Link>
                </li>
                <li>
                  <Link to="/other/ag-grid" className="dropdown-item">Ag-Grid</Link>
                </li>                        
                <li>
                ...
                <li className="nav-item dropdown">
                  <Link to="" className="nav-link dropdown-toggle" id="navbarSubMenuSpecial" role="button" data-bs-toggle="dropdown" aria-expanded="false">Sub Menu Special</Link>
                  {/*<Link to="/other" className="nav-link">Other</Link>*/}
                  <ul className="dropdown-menu" aria-labelledby="navbarSubMenuSpecial">      
                    <li>
                      <Link to="/special/s1" className="dropdown-item">Sub Menu 1</Link>
                    </li>
                    <li>
                      <Link to="/special/s2" className="dropdown-item">Sub Menu 2</Link>
                    </li>                        
                    <li>
                      <Link to="/special/s3" className="dropdown-item">Sub Menu 3</Link>
                    </li>                        
                    <li>
                      <Link to="/special/s3" className="dropdown-item">Sub Menu 4</Link>
                    </li>                                            
                  </ul>              
                </li>

                <li>
                  <Link to="/other/logout" className="dropdown-item">Logout</Link>
                </li>                        
              </ul>              
            </li>
            <li className="nav-item">
    ...
    <Switch>
      <Route path="/about">
        <h5>The following data is retrieved from API in the server using Laravel Sanctum</h5>
        <p />
        <MyAbout />
      </Route>
      <Route path="/topics">
      ...
      <Route path="/other/:actionId">
        <Action theme={theme} changeTheme={toggleTheme} />
      </Route>      
      <Route path="/other">
        <Other2 />
      </Route>
...
function Action(props) {
    ...
    switch (actionId) {      
        case "tabulator":
            return (
                <ThemeContext.Provider value={props.theme}>
                  <MyDataGrid changeTheme={props.changeTheme} />
        ...
        case "mousetracker":
            //return <MouseTracker />;
            //return <FuncMouseTracker />;
            return <HOCMouseTracker />;
